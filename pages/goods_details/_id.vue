  ...
  <div class="goods-details" v-if="goodsDetails.id">
    <div class="goods-info flex">
      ...
      <div class="info-wrap bg-white flex-1">
        ...
        <div
          class="price-wrap flex-between white seckill"
        ...
        <div class="price-wrap flex flex row-between lighter" v-else>
          <div class="price flex" style="align-items: baseline">
            ...
            <div class="primary">
              <price-formate
                :price="checkedGoods.sell_price || goodsDetails.sell_price"
                :subscript-size="16"
                :first-size="30"
                :second-size="16"
              />
            ...
            <div class="line-through m-l-8 muted">
              <price-formate
                :price="
                  checkedGoods.lineation_price || goodsDetails.lineation_price
                "
              />
            </div>
          </div>
          <div class="flex">
            ...
            <div style="margin-right: 60px">
              <div class="m-b-8">{{ $t("浏览量") }}</div>
              <div>{{ goodsDetails.click_num }}</div>
            </div>
            <div>
            ...
            >
              ...
              <div class="price flex m-t-8">
                ...
                <div class="muted sm line-through">
                  <price-formate :price="item.min_lineation_price" />
                </div>
              </div>
            </div>
          </template>
...
export default {
  ...
  async asyncData({ params, $get, app, query }) {
    const { data, code, msg } = await $get("pc/goodsDetail", {
      params: {
        goods_id: query.id,
        visit: 1,
      },
  ...
  methods: {
    ...
    async getGoodsDetail() {
      const { data, code } = await this.$get("pc/goodsDetail", {
        params: {
          goods_id: this.id,
          visit: 1,
        },
